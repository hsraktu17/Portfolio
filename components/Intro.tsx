...
export default function Intro() {
  ...
  return (
    <div
      className="font-sans min-h-screen grid place-items-center p-12"
      id="intro"
    >
      <div className="grid gap-y-4 text-center">
        <div className="font-bold text-5xl mt-20">Hi, this is Utkarsh.</div>
        <div className="text-xl">
          A passionate full-stack developer, currently a final-year student at
          Reva University.
        </div>
        <div className="text-xl">
          I thrive on creating robust web applications.
        </div>
        <div className="flex justify-center items-center mt-5 space-x-4">
          <a
            ...
            href="https://www.linkedin.com/in/utkarsh-raj-srivastava-037891214/"
          >
            <BsLinkedin />
          </a>
          <a
            className="px-6 py-3 border border-gray-500 rounded-full hover:bg-gray-500 hover:text-white transition duration-300 ease-in-out"
            href="https://github.com/hsraktu17"
          >
            <ImGithub />
          </a>
          <a
            className="px-6 py-3 border border-gray-500 rounded-full hover:bg-gray-500 hover:text-white transition duration-300 ease-in-out"
            href="https://twitter.com/Im__Utkarsh"
          >
            <FaXTwitter />
          </a>
          <a
            className="px-6 py-3 border border-gray-500 rounded-full hover:bg-gray-500 hover:text-white transition duration-300 ease-in-out"
            href="https://leetcode.com/Utkarsh172/"
          >
            <SiLeetcode />
          </a>
        </div>
