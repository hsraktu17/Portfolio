  ...
  return (
    <div className="font-sans min-h-screen grid place-items-center p-12" id="intro">
      <div className="grid gap-y-4 text-center">
        ...
        <div>
          <a className="px-6 py-3 border border-gray-500 rounded-full hover:bg-gray-500 hover:text-white transition duration-300 ease-in-out" href="https://drive.google.com/file/d/1tdAIfDxFg6MpMAzHuEMbDotduHibpd-T/view?usp=sharing">Resume</a>
        </div>
