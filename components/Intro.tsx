...
export default function Intro() {
  ...
  return (
    <div className="font-sans min-h-screen grid place-items-center p-12" id="intro">
      <div className="grid gap-y-4 text-center">
        ...
        <div>
          <a className="px-6 py-3 border border-gray-500 rounded-full hover:bg-gray-500 hover:text-white transition duration-300 ease-in-out" href="https://drive.google.com/file/d/1d1_0FCWrjGP6366AbJl_DGAqq0kf5T_8/view?usp=drive_link">Resume</a>
        </div>
